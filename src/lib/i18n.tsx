...
const ZH_TRANSLATIONS: Record<string, string> = {
  ...
  "To-do list": "待办事项",
  "Open to-dos": "待办事项",
  "Completed to-dos": "已完成待办",
  "Milestones achieved": "已达成里程碑",
  "Activity items": "动态记录",
  "Remove this staff member?": "移除这名员工？",
  ...
  "View team member details": "查看团队成员详情",
  "Current project": "当前项目",
  "Other projects": "其他项目",
  "No other projects assigned.": "未分配其他项目。",
  Inactive: "未启用",
  ...
  "Project work logs and public GitHub commits, newest first. This is not website visitor analytics.":
    "项目工作日志和公开 GitHub 提交，按最新顺序显示。这不包含网站访客分析。",
  "Project work logs visible to your account, newest first.":
    "按最新顺序显示您的账户可见的项目工作日志。",
  "Delete activity": "删除动态",
  "Delete this activity?": "删除这条动态？",
  "This removes the activity from the project timeline and cannot be undone.":
    "这会从项目时间线中移除该动态，且无法撤销。",
  "Only admins can delete project activity": "仅管理员可删除项目动态",
  "Activity deleted": "动态已删除",
  "Could not delete activity": "无法删除动态",
  ...
  "Upload photo": "上传头像",
  "Staff avatar": "员工头像",
  "Selected photo uploads when staff details are saved.": "已选择头像，保存员工详细信息时上传。",
  "Remove photo": "移除头像",
  "Photo updated": "头像已更新",
  "Photo removed": "头像已移除",
  ...
  "Discard draft": "放弃草稿",
  "Open staff details": "打开员工资料",
  "Admin note": "管理员备注",
  "Only admins can read this note.": "只有管理员可以查看此备注。",
  Roles: "角色",
  "No staff yet.": "暂无员工。",
  ...
  "Project team": "项目团队",
  "Assign people directly to this project.": "直接为此项目分配人员。",
  selected: "已选择",
  "Selected staff": "已选择员工",
  "Remove from selection": "从选择中移除",
  "Filter staff by department": "按部门筛选员工",
  "All departments": "所有部门",
  "No department": "未分配部门",
  "No staff in this department.": "该部门没有可选员工。",
  ...
  "Play video": "播放视频",
  "Remove video": "移除视频",
  "Existing attachments": "现有附件",
  "Drag photos or videos here or tap to choose": "拖放图片或视频到这里，或点击选择",
  "MP4, WebM or MOV · Up to 2 · 50 MB each": "MP4、WebM 或 MOV · 最多 2 个 · 每个 50 MB",
  "Use MP4, WebM or MOV under 50 MB": "请使用小于 50 MB 的 MP4、WebM 或 MOV 视频",
  "You can add up to 2 videos": "最多可添加 2 个视频",
  "Photos are compressed to WebP in your browser before upload. Videos are uploaded as recorded.":
    "图片会在浏览器中压缩为 WebP 后上传；视频按原样上传。",
  "Uploading photos…": "正在上传图片…",
  "Uploading video {n} of {total}…": "正在上传视频 {n}/{total}…",
  "Copying attachments…": "正在复制附件…",
