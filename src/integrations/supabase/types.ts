    ...
    Tables: {
      ...
      projects: {
        Row: {
          ...
          license_status: "licensed" | "in_process" | "expired" | "unknown";
          location: string | null;
          mining_method: "alluvial" | "open_pit" | "underground" | "exploration" | "other";
          name: string;
      ...
      reports: {
        Row: {
          ...
          shift: "day" | "night" | "other";
          title: string;
          updated_at: string;
          user_id: string;
          work_status: "completed" | "in_progress" | "blocked";
        };
        Insert: {
          blockers?: string | null;
          content: string;
